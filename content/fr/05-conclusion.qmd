...
- **Transversale** ({N_PAYS} pays, {ANNEE_CROSS}) : β₃ = {BETA3:.4f}{stars_cross} 
  → **U inversé renforcé** : le découplage s'accélère aux hauts revenus

- **Temporelle** (USA, {ANNEE_DEBUT}-{ANNEE_FIN}) : β₃ = {BETA3_USA:.4f} (p={PVAL3_USA:.3f})
  → **Non significatif** : le modèle quadratique suffit
"""))
```
