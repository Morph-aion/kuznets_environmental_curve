...
|----------|----------|-------------|---------|
| $\\ln(\\text{{PIB}})$ centré | {format_coef(m_lin, 'log_gdp_c')} | {format_coef(m_quad, 'log_gdp_c')} | {format_coef(m_cub, 'log_gdp_c')} |
| $[\\ln(\\text{{PIB}})]^2$ | — | {format_coef(m_quad, 'I(log_gdp_c ** 2)')} | {format_coef(m_cub, 'I(log_gdp_c ** 2)')} |
| $[\\ln(\\text{{PIB}})]^3$ | — | — | {format_coef(m_cub, 'I(log_gdp_c ** 3)')} |
...
- **Diagnostic : Courbe en N détectée.**
